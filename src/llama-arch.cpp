...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FFN_GATE_EXPS_MID, "blk.%d.ffn_gate_exps_mid" },
    { LLM_TENSOR_FFN_UP_EXPS_MID, "blk.%d.ffn_up_exps_mid" },
    { LLM_TENSOR_FFN_DOWN_EXPS_MID, "blk.%d.ffn_down_exps_mid" },
    { LLM_TENSOR_FFN_EXP_TIER_IDS_MID, "blk.%d.ffn_exp_tier_ids_mid" },
    { LLM_TENSOR_FFN_EXP_TIER_MASK_MID, "blk.%d.ffn_exp_tier_mask_mid" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_FFN_GATE_EXPS_MID, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_UP_EXPS_MID, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_DOWN_EXPS_MID, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT_ID}},
    {LLM_TENSOR_FFN_EXP_TIER_IDS_MID, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_FFN_EXP_TIER_MASK_MID, {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
