...
enum llm_tensor {
    ...
    // tiered expert packs: the full expert set split into several tensors by
    // activation frequency, each dispatched separately from one shared routing
    LLM_TENSOR_FFN_GATE_EXPS_HOT,
    LLM_TENSOR_FFN_UP_EXPS_HOT,
    LLM_TENSOR_FFN_DOWN_EXPS_HOT,
    LLM_TENSOR_FFN_GATE_EXPS_MID,
    LLM_TENSOR_FFN_UP_EXPS_MID,
    LLM_TENSOR_FFN_DOWN_EXPS_MID,
    LLM_TENSOR_FFN_GATE_EXPS_COLD,
    LLM_TENSOR_FFN_UP_EXPS_COLD,
    LLM_TENSOR_FFN_DOWN_EXPS_COLD,
    LLM_TENSOR_FFN_EXP_TIER_IDS_HOT,
    LLM_TENSOR_FFN_EXP_TIER_MASK_HOT,
    LLM_TENSOR_FFN_EXP_TIER_IDS_MID,
    LLM_TENSOR_FFN_EXP_TIER_MASK_MID,
    LLM_TENSOR_FFN_EXP_TIER_IDS_COLD,
    LLM_TENSOR_FFN_EXP_TIER_MASK_COLD,
